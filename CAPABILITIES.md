...
- **Remember-me** — 30 дней против 4 часов
...
|---|---|---|---|---|---|---|---|
| **admin** | Все | Да | Все переходы | Да | Да | Да | Да |
| **dispatcher** | Все | Да | Нет | Да | Нет | Нет | Да |
| **engineer** | Свои | Нет | Свои по FSM | Нет | Нет | Нет | Нет |
| **storekeeper** | Нет | Нет | Нет | Нет | Да | Нет | Нет |
| **customer** | Свои | Нет | Нет | Нет | Нет | Нет | Нет |
...
- Чек-листы обязательны при `REVIEW → COMPLETED`
